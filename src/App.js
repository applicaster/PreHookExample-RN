...
class App extends Component {
  ...
  componentWillMount() {
    ...
    if (Platform.OS === "ios") {
      ...
      this.screenWillDismissSubscription = eventEmitter.addListener(
        SCREEN_WILL_DISMISS,
        this.screenWillDismissCallback
      );
    } else {
    ...
    return (
      <View style={styles.container}>
        <View>
          ...
          <TouchableOpacity
            onPress={this.hookFinishedWithSuccessWithRemoveFromStack}
          >
            <Text style={styles.button}>
              Hook Finished Success Remove From Stack
            </Text>
          </TouchableOpacity>
